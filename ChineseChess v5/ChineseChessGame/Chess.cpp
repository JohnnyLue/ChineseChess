...
void General::move(Board& Board) {
	checkBorderLimit(loc, 1, 0, isRed, Board.board);
	checkBorderLimit(loc, -1, 0, isRed, Board.board);
	checkBorderLimit(loc, 0, -1, isRed, Board.board);
	checkBorderLimit(loc, 0, 1, isRed, Board.board);
}

void General::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Warrior::move(Board&Board) {
	checkBorderLimit(loc,  1,  1, isRed, Board.board);
	checkBorderLimit(loc, -1,  1, isRed, Board.board);
	checkBorderLimit(loc,  1, -1, isRed, Board.board);
	checkBorderLimit(loc, -1, -1, isRed, Board.board);
}

void Warrior::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Elephant::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Horse::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Tank::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Cannon::move(Board&board) {
	...
	if (!board.board[up.first][up.second].empty()){
		...
		if (!board.board[tmp.first][tmp.second].empty()) {
...
void Cannon::eat(pair<int, int>, pair<int, int>, Board&) {
...
void Soldier::eat(pair<int, int>, pair<int, int>, Board&) {
